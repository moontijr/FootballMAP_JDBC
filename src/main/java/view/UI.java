    ...
    private void subMenuCoach(Coach coach) throws SQLException {
        ...
        switch (choice2) {
            ...
            case 5:
                ...
                System.out.println(team1.squad.size());
                ...
                System.out.println(coach.getTeam().transferPlayerToTeam(player1, team1));
                this.subMenuCoach(coach);
                break;

            case 6:
                Player player2 = null;
                System.out.println(coach.getTeam().getSquad().size());
                System.out.println(coach.getTeam().squad.size());
                System.out.println("Tell us the details of the followed player:");
                this.userInput.nextLine();
                System.out.println("First Name: ");
